        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="my_profile_edit_2.php" >
                  <span data-feather="shopping-cart"></span>
                  Education Qualifications
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="my_profile_edit_3.php">
...
function fill_unit_select_box($connect)
{
 ...
 {
   if($row["qualificationCategory"]!="General"){
...
?>
  ...
  <div class="container">
   <h4 align="center">Enter Educational Details</h4>
   <br />
