...
?>
  ...
  <div class="container">
   <h3 align="center"><?php echo _s_Enter_Professional_Details; ?></h3>
   <br />
   <form method="post" id="insert_form">
    <div class="table-repsonsive">
     ...
     <div align="center">
      <input type="submit" name="submit"  value=<?php echo _s_Insert; ?> class="w3-input" style="color:azure; background-color: #012641; width:100px;"/>
     </div>
    </div>
   </form>
  </div>
