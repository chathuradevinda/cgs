...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="index_company.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Home</a>
  <a href="find_candidate.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Search Candidates</a>
  <a href="add_vacancy.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Publish Vacancy</a>
  <a href="add_event.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Publish Event</a>
  

  <a href="logout_student.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-white">Logout <span class="glyphicon glyphicon-log-out w3-margin-right"></span></a>
...
<div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
  <div class="w3-row">
    ...
    <div class="w3-padding-16"><span class="w3-xlarge w3-border-teal w3-bottombar">Contact Us</span></div>
      ...
      <p><i class="fa fa-map-marker w3-text-teal w3-xlarge"></i>  No 15, Chatham Street, Colombo</p>
      <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i>  +94 11 2237223</p>
      <p><i class="fa fa-envelope-o w3-text-teal w3-xlarge"></i>  info@skillpoint.com</p>
    </div>
