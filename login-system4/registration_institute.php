...
// define variables and set to empty values
    $institutenameErr = $telephone1Err = $telephone2Err = $pwdErr = "";
    $institutename = $telephone1 = $telephone2 = $pwd = "";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST["institutename"])) {
            $institutenameErr = "Name is required";
            $valid = false;
        } else {
            $institutename = test_input($_POST["institutename"]);
            // check if name only contains letters and whitespace
            if (!preg_match("/^[a-zA-Z ]*$/", $institutename)) {
                $institutenameErr = "Only letters and white space allowed";
                $valid = false;
            }
        }
        ...
        if (empty($_POST["telephone2"])) {
            $telephone2Err = "telephone2 is required";
            $valid = false;
        } else {
            $telephone2 = test_input($_POST["telephone2"]);
            // check if name only contains letters and whitespace
            if (!preg_match("/^[0-9]{10}$/", $telephone2)) {
                $telephone2Err = "Invalid telephone2 format";
                $valid = false;
            }
        }
...
// Set session variables to be used on profile.php page
            ...
            $_SESSION['institute_name'] = $_POST['institutename'];
            $_SESSION['website'] = $_POST['website'];

// Escape all $_POST variables to protect against SQL injections
            $institute_name = $mysqli->escape_string($_POST['institutename']);
...
// We know user email exists if the rows returned are more than 0
            if ($result->num_rows > 0) {
                ...
                $sql = "INSERT INTO user ( email,hash,userCategory, password) VALUES ('" . $email . "','" . $hash . "','2', '" . $password . "')";
                ...
                if ($mysqli->query($sql) === TRUE) {
                    ...
                    $sql_3 = "INSERT INTO institute (userID, instituteName, website,regNo, telephone1,telephone2,fax) VALUES ($last_id,'".$institute_name."','".$website."','".$regNo."','$telephone1','$telephone2','$fax')";
        ...
        http://localhost/login-system4/verify.php?email=' . $email . '&hash=' . $hash;
                    ...
                    header("location: profile_institute.php");
                } else {
...
<div class="w3-container w3-theme">
    ...
    <div class="form-group">
                            <label>
                                institute Name<span class="req">*</span>
                            </label>
                            <input class="w3-input" placeholder="Enter Institutes Name" type="text" required autocomplete="off" name='institutename' required value ="<?php echo $institutename; ?>" />
                            <span class="error">* <?php echo $institutenameErr; ?></span>
                        </div>
    ...
    <div class="form-group">
                            ...
                            <input class="w3-input" type="text" placeholder="Enter Website" required autocomplete="off" name='website' required value ="<?php //echo $lastname;   ?>" />
    ...
    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input class="w3-input" type="text"  name="address_no" placeholder="Enter address " >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input  type="text" class="w3-input" name="telephone1" placeholder="Enter Telephone No1" maxlength="10" required value ="<?php echo $telephone1; ?>"  >
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="w3-input" name="telephone2" placeholder="Enter Telephone No2" maxlength="10" required value ="<?php echo $telephone1; ?>">
