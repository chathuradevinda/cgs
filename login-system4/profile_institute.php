...
<head>
  <meta charset="UTF-8">
  <title>Welcome <?= $institute_name ?></title>
  ...
  <div class="w3-container w3-theme">
          ...
          if ( !$active ){
              ...
              on the email link!
               ...
               header("location: index_institute.php");    
          ...
          <p><?= $email ?></p>
                    ...
                    <a href="logout.php"><button type="submit" value="Login" name="logout" class="w3-input" style="width:50px;"/>Log Out</button></a>
