...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="index_institute.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Home</a>
  <a href="add_course.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Publish Course</a>
  <a href="add_event.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Publish Event</a>
  <a href="edit_course.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Edit Course Details</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
    <a href="add_course.php" class="w3-bar-item w3-button">Publish Course</a>
    ...
    <a href="logout_institute.php" class="w3-bar-item w3-button">Logout</a>
  </div>
</div>
